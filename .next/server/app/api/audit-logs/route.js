"use strict";(()=>{var e={};e.id=108,e.ids=[108],e.modules={5890:e=>{e.exports=require("better-sqlite3")},2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},4770:e=>{e.exports=require("crypto")},2048:e=>{e.exports=require("fs")},5315:e=>{e.exports=require("path")},6005:e=>{e.exports=require("node:crypto")},7254:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>N,patchFetch:()=>R,requestAsyncStorage:()=>u,routeModule:()=>T,serverHooks:()=>_,staticGenerationAsyncStorage:()=>c});var i={};a.r(i),a.d(i,{GET:()=>l,dynamic:()=>d});var r=a(9303),n=a(8716),s=a(670),E=a(7070),o=a(2704),p=a(5185);let d="force-dynamic";async function l(e){try{let t=await (0,o.k)(e);if(t instanceof E.NextResponse)return t;let{searchParams:a}=new URL(e.url),i=a.get("user_id"),r=a.get("application_id"),n=parseInt(a.get("limit")||"100"),s=(i?p.c8.findByUserId(parseInt(i),n):r?p.c8.findByApplicationId(parseInt(r)):p.c8.findByUserId(0,n)).map(e=>({...e,details:e.details?JSON.parse(e.details):null}));return E.NextResponse.json({logs:s,count:s.length})}catch(e){return console.error("Get audit logs error:",e),E.NextResponse.json({error:"Internal server error"},{status:500})}}let T=new r.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/audit-logs/route",pathname:"/api/audit-logs",filename:"route",bundlePath:"app/api/audit-logs/route"},resolvedPagePath:"/Users/michaeltornaritis/Desktop/Treasury_Take_Home/app/api/audit-logs/route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:u,staticGenerationAsyncStorage:c,serverHooks:_}=T,N="/api/audit-logs/route";function R(){return(0,s.patchFetch)({serverHooks:_,staticGenerationAsyncStorage:c})}},9178:(e,t,a)=>{a.d(t,{SO:()=>p,So:()=>d,ed:()=>o,ts:()=>l});var i=a(3400),r=a(8547),n=a(5185);let s=new Map;async function E(e,t){return i.ZP.compare(e,t)}function o(e){let t=(0,r.Z)(),a=Date.now()+864e5;return s.set(t,{userId:e,expiresAt:a}),function(){let e=Date.now();for(let[t,a]of s.entries())e>a.expiresAt&&s.delete(t)}(),t}function p(e){s.delete(e)}async function d(e,t){let a=n.tJ.findByEmail(e);return a&&await E(t,a.password_hash)?(n.tJ.updateLastLogin(a.id),n.c8.create(a.id,"login"),a):null}function l(e){if(!e)return null;let t=function(e){let t=s.get(e);return t?Date.now()>t.expiresAt?(s.delete(e),null):{userId:t.userId}:null}(e);return t&&n.tJ.findById(t.userId)||null}},5185:(e,t,a)=>{a.d(t,{M1:()=>n,c8:()=>E,tJ:()=>r,uH:()=>s});var i=a(9487);(0,a(5176).T)();let r={create:(e,t,a,r="agent")=>i.Z.prepare(`
  ...
  `),r=!0}catch(e){if(process.env.NEXT_PHASE,e instanceof Error&&e.message.includes("Database not available"))return;throw e}}}};var t=require("../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),i=t.X(0,[276,972,955],()=>a(7254));module.exports=i})();