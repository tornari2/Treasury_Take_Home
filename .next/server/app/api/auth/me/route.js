"use strict";(()=>{var e={};e.id=788,e.ids=[788],e.modules={5890:e=>{e.exports=require("better-sqlite3")},2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},4770:e=>{e.exports=require("crypto")},2048:e=>{e.exports=require("fs")},5315:e=>{e.exports=require("path")},6005:e=>{e.exports=require("node:crypto")},2513:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>_,patchFetch:()=>T,requestAsyncStorage:()=>E,routeModule:()=>c,serverHooks:()=>R,staticGenerationAsyncStorage:()=>m});var a={};r.r(a),r.d(a,{GET:()=>d,dynamic:()=>l});var n=r(9303),i=r(8716),s=r(670),o=r(7070),p=r(9178),u=r(1615);let l="force-dynamic";async function d(e){try{let e=await (0,u.cookies)(),t=e.get("session")?.value;if(!t)return o.NextResponse.json({error:"Not authenticated"},{status:401});let r=(0,p.ts)(t);if(!r)return o.NextResponse.json({error:"Not authenticated"},{status:401});return o.NextResponse.json({user:{id:r.id,email:r.email,name:r.name,role:r.role}})}catch(e){return console.error("Get user error:",e),o.NextResponse.json({error:"Internal server error"},{status:500})}}let c=new n.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/auth/me/route",pathname:"/api/auth/me",filename:"route",bundlePath:"app/api/auth/me/route"},resolvedPagePath:"/Users/michaeltornaritis/Desktop/Treasury_Take_Home/app/api/auth/me/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:E,staticGenerationAsyncStorage:m,serverHooks:R}=c,_="/api/auth/me/route";function T(){return(0,s.patchFetch)({serverHooks:R,staticGenerationAsyncStorage:m})}},9178:(e,t,r)=>{r.d(t,{SO:()=>u,So:()=>l,ed:()=>p,ts:()=>d});var a=r(8691),n=r(8547),i=r(909);let s=new Map;async function o(e,t){return a.ZP.compare(e,t)}function p(e){let t=(0,n.Z)(),r=Date.now()+864e5;return s.set(t,{userId:e,expiresAt:r}),function(){let e=Date.now();for(let[t,r]of s.entries())e>r.expiresAt&&s.delete(t)}(),t}function u(e){s.delete(e)}async function l(e,t){let r=i.tJ.findByEmail(e);return r&&await o(t,r.password_hash)?(i.tJ.updateLastLogin(r.id),i.c8.create(r.id,"login"),r):null}function d(e){if(!e)return null;let t=function(e){let t=s.get(e);return t?Date.now()>t.expiresAt?(s.delete(e),null):{userId:t.userId}:null}(e);return t&&i.tJ.findById(t.userId)||null}},909:(e,t,r)=>{r.d(t,{M1:()=>E,c8:()=>R,uH:()=>m,tJ:()=>c});var a=r(5890),n=r.n(a),i=r(5315),s=r.n(i),o=r(2048),p=r.n(o);let u=process.env.DATABASE_PATH||"./data/database.db",l=s().dirname(u);p().existsSync(l)||p().mkdirSync(l,{recursive:!0});let d=new(n())(u);d.pragma("foreign_keys = ON");let c={create:(e,t,r,a="agent")=>d.prepare(`
    ...
    `).all(e,t),findByApplicationId:e=>d.prepare(`
      ...
      ORDER BY timestamp DESC
    `).all(e)}}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[276,2],()=>r(2513));module.exports=a})();