"use strict";(()=>{var e={};e.id=829,e.ids=[829],e.modules={5890:e=>{e.exports=require("better-sqlite3")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2048:e=>{e.exports=require("fs")},5315:e=>{e.exports=require("path")},4534:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>_,patchFetch:()=>I,requestAsyncStorage:()=>c,routeModule:()=>N,serverHooks:()=>u,staticGenerationAsyncStorage:()=>l});var i={};a.r(i),a.d(i,{GET:()=>p,dynamic:()=>d});var E=a(9303),r=a(8716),s=a(670),T=a(7070),n=a(9487),o=a(5176);let d="force-dynamic";async function p(){try{return n.Z.prepare("SELECT 1").get(),T.NextResponse.json({status:"healthy",timestamp:new Date().toISOString(),database:"connected"},{status:200})}catch(e){return T.NextResponse.json({status:"unhealthy",timestamp:new Date().toISOString(),database:"disconnected",error:e instanceof Error?e.message:"Unknown error"},{status:503})}}(0,o.T)();let N=new E.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/health/route",pathname:"/api/health",filename:"route",bundlePath:"app/api/health/route"},resolvedPagePath:"/Users/michaeltornaritis/Desktop/Treasury_Take_Home/app/api/health/route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:c,staticGenerationAsyncStorage:l,serverHooks:u}=N,_="/api/health/route";function I(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:l})}},9487:(e,t,a)=>{a.d(t,{Z:()=>p});var i=a(5890),E=a.n(i),r=a(5315),s=a.n(r),T=a(2048),n=a.n(T);let o=process.env.DATABASE_PATH||"./data/database.db",d=null,p="phase-production-build"===process.env.NEXT_PHASE?new Proxy({},{get:()=>()=>{throw Error("Database not available during build")}}):new Proxy({},{get(e,t){let a=function(){if(!d){if("phase-production-build"===process.env.NEXT_PHASE)throw Error("Database initialization skipped during build phase");try{let e=s().dirname(o);n().existsSync(e)||n().mkdirSync(e,{recursive:!0}),(d=new(E())(o)).pragma("foreign_keys = ON")}catch(e){throw e}}return d}(),i=a[t];return"function"==typeof i?i.bind(a):i}})},5176:(e,t,a)=>{a.d(t,{T:()=>r});var i=a(9487);let E=!1;function r(){if(!E)try{i.Z.exec(`
