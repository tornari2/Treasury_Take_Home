...

{
  "extraction": {
    ...
    "producerAddress": "exact text (city, state) or null",
    "producerNamePhrase": "exact text of the phrase immediately preceding producer name/address (e.g., 'Bottled By', 'Imported By', 'Bottled by', 'Imported by', or null if no such phrase)",
    "healthWarningText": "exact full text of health warning, preserve ALL caps and punctuation exactly as shown, or null",
